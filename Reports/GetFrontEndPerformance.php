 ...
 */
class GetFrontEndPerformance extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('FrontEndPerformance_FrontEndPerformance');
        ...
        // $this->menuTitle    = 'FrontEndPerformance_FrontEndPerformance';
        ...
        // $this->widgetTitle  = 'FrontEndPerformance_FrontEndPerformance';
    }
    ...
    {
        $view = new View('@FrontEndPerformance/getFrontEndPerformance');
        $view->myData = array();
